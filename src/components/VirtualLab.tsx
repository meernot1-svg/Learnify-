...
export default function VirtualLab({
  ...
  return (
    ...
    >
      ...
      <div className="flex bg-card/80 backdrop-blur-xl border border-border/50 p-1 rounded-2xl w-full max-w-3xl mx-auto shadow-2xl overflow-hidden no-scrollbar-x">
        {[
